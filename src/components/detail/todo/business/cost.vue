...
<template>
  ...
  <div>
    <x-table>
      ...
      <tr>
        <td class="detail-page-name">业务分类</td>
        <td>{{info.businessClass}}</td>
        <td class="detail-page-name">委托目的</td>
      ...
      <tr>
        <td class="detail-page-name detail-page-img">造价文件</td>
...
<script>
  ...
  var CostPage = Vue.extend({})
  Vue.component('cost-page', CostPage)
  ...
  export default {
    ...
    methods: {
      getImg (imgType) {
        // if(imgType == 'worktree' && this.picArr1.length>0){//造价文件
        //   this.showImg(1);
